    ...
    <div id="page-wrapper">
                        ...
                        <div id="menu">
                            <ul>
                               ...
                               <!-- <li><a href="#">Sign Up</a></li>-->
                                <li><a href="\login-10">Log In</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
        ...
        <section id="banner">
            <div class="inner">
                ...
                <p>Welcome to the finest interglobal<br />online math competition<br />crafted by Group-C.</p>
        ...
        <footer id="footer">
            ...
            <ul class="copyright">
                <li>&copy; Matheletics. All rights reserved.</li><li>Design: <a href="http://html5up.net">HTML5 UP</a></li>
            </ul>
        </footer>
