...
public class Authenticator {
                            ...
                            while(true) {
                                ...
                                switch (actions[0]) {
                                    ...
                                    case "attemptChallenge":
                                        Pupil.attemptChallenge(out,in,actions,username);
                                        out.println();
                                        break;
                                    case "logout":
                    ...
                    case "sr":
                        if (Model.checkSRLogin(username, password)) {
                            ...
                            while (true) {
                                ...
                                switch (actions[0]) {
                                    case "viewApplicants":
                                        SchoolRepresentative.viewApplicants(username, out);
    ...
    //create files for storing pupils that have registered and are waiting for confirmation
    public static void createPupilFile(String filename) {
        try {
